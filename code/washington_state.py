...
school = 'washington_state'
url_template = 'http://wsucougars.com/roster.aspx?path={sporturl}'
...
sports_dict['mens golf'] = ['mglf']
sports_dict['womens golf'] = ['wglf']
