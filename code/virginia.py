...
##### virginia #################
school = 'virginia'
url_template = 'https://virginiasports.com/roster.aspx?path={sporturl}'
...
sports_dict['mens track'] = ['xctrack']
sports_dict['womens track'] = ['xctrack']
...
sports_dict['mens squash'] = ['msquash']
